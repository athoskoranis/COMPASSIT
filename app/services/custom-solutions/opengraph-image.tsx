...
// Next's root opengraph-image does not cascade into child segments, so a page
// without its own file shares as a bare link. Same layout as the other service
// pages: eyebrow, page title, brand line, service lines.
export const runtime = 'edge'
export const alt = 'Custom Solutions — Web Platforms & Tools · Compass ITS'
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', backgroundColor: '#0B0E10', padding: '80px 96px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', fontSize: 18, color: 'rgba(244,242,236,0.35)', letterSpacing: '0.04em' }}>
          Web platforms · Internal tools · Data products · Integrations
        </div>
