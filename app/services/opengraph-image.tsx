...
// without its own file shares as a bare link. Every service page under this one
// already declares one; the hub needs the same. Copy follows the sibling
// pattern: eyebrow, page title, brand line, service lines.
export const runtime = 'edge'
export const alt = 'IT Services & Solutions — Compass IT Solutions'
