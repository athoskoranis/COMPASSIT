...
export const metadata: Metadata = {
  ...
  openGraph: { url: '/ar/services/network-infrastructure', locale: 'ar_QA', images: ['/services/network-infrastructure/opengraph-image'] },
  twitter: { images: ['/services/network-infrastructure/opengraph-image'] },
}
