...
// Next's root opengraph-image does not cascade into child segments, so this page
// shared as a bare link until this file existed. Structure follows the service
// pages; copy is the page's own h1 and the six step names from CONTENT.md.
export const runtime = 'edge'
export const alt = 'How We Work — Six steps, nothing skipped · Compass ITS'
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', backgroundColor: '#0B0E10', padding: '80px 96px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', fontSize: 18, color: 'rgba(244,242,236,0.35)', letterSpacing: '0.04em' }}>
          Discovery · Strategy · Creativity · Execution · Optimisation · Reporting
        </div>
