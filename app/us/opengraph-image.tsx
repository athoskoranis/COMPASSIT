...
// Every route declares its own. Next's root opengraph-image does not cascade
// into child segments, and npm run check:og covers the blog only — see the
// "Not outstanding" note in HANDOVER.md.
export const runtime = 'edge'
export const alt = 'Point-of-Sale Analytics, Portland Oregon — Compass IT Solutions'
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', backgroundColor: '#0B0E10', padding: '80px 96px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', fontSize: 18, color: 'rgba(244,242,236,0.35)', letterSpacing: '0.04em' }}>
          Prime cost · Labor by daypart · Item margin · Multi-location
        </div>
