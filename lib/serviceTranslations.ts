    ...
    sections: [
      {
        ...
        items: [
          { title: 'Risk Assessment', description: 'We find the gaps in your systems and work out what each one would mean for data integrity, confidentiality, and availability. Then we recommend the countermeasures that reduce both the risk and the damage a breach could do.' },
          { title: 'Cybersecurity', description: 'We help you treat security as a programme rather than a series of purchases: what to protect first, what to spend on it, and how the parts fit together with the rest of your technology.' },
          { title: 'Security Assessment', description: "We review your security controls against the standards, laws, and practices that apply to you. The review says which controls work, which do not, and where you are non-compliant." },
          { title: 'Impact Assessment', description: "We work out what a security incident would actually do to your systems, assets, and daily operations. Risks are ranked by what they would cost you, and each one gets a mitigation plan." },
          { title: 'Security Implementations & Trainings', description: "We put the controls in place: firewalls, VPNs, and intrusion detection and prevention (IDPS) across your network and data. We train your staff to use them, because a control nobody follows protects nothing." },
          { title: 'Business Continuity Planning', description: 'A breach or an outage will interrupt your business. The plan decides in advance what comes back first, who does it, and how long each step should take, so the decisions are already made when it happens.' },
          { title: 'Vulnerability Assessment & Penetration Testing (VAPT)', description: 'A controlled attack on your own systems, run with your permission, to find the weak points in what you own: computers, servers, firewalls, and networks. Worth doing whatever the size of the business.' },
          { title: 'ISO Compliance', description: "We help you meet the ISO standards that apply to your business, and get certified. An ISO standard sets out what good practice looks like for the quality, safety, and reliability of what you sell." },
          { title: 'Data Privacy and Security', description: 'Privacy rules are tightening and customers expect more control over their data. Holding personal information now carries regulatory, reputational, and privacy risk at the same time.' },
        ],
      },
    ],
    whyUs: {
    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: 'Ecommerce Solution', description: 'Our developers build bespoke online stores designed to turn visitors into repeat customers.' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: 'Design', description: 'We create mockups and workflows that are perfect to give you an app-like feel. Our cloud solutions experts design several deployment models to keep your business goals in focus.' },
    ...
    sections: [
      {
        ...
        items: [
          { title: 'Routers, Switches & Wireless Devices', description: "These are easy to under-plan. How many routers you need, where the switches go, and how many devices each one has to carry are all easy to get wrong. We size and place them for the way your office actually works." },
          { title: 'Network Security', description: "Your customers expect you to be available now, which leaves no room for downtime from a security incident or a network failure. We protect the systems that keep you online." },
...
const digitalMarketing: Record<Lang, ServicePageData> = {
  en: {
    hero: {
      ...
      subtitle: 'SEO, Google Ads, social media, content, and analytics under one strategy. Measured weekly, optimised monthly.',
    ...
    sections: [
      {
        ...
        intro: 'We run every channel under one strategy and measure it against business outcomes rather than activity. SEO to earn rankings, Google Ads for immediate demand, social to build the brand. Programmes are built to compound, not to spike and fade.',
        items: [
          { title: 'Search Engine Optimisation (SEO)', description: 'Technical SEO, on-page optimisation, content strategy, and authority building, structured to move rankings and bring in qualified organic traffic. Every recommendation starts from data: keyword opportunity, competitive gaps, and crawl health. We target the search terms your customers actually use.' },
          { title: 'Search Engine Marketing (SEM) — Google Ads', description: 'Google Ads and Bing Ads campaigns managed to a clear performance brief. We handle keyword research, ad copy, bid strategy, audience targeting, and landing page alignment — reviewed and optimised monthly. Budget is allocated to what drives revenue, not what looks active on a dashboard.' },
          { title: 'Social Media Marketing', description: 'Organic and paid social across LinkedIn, Instagram, and X. Content calendars built from audience insight and local market context — not generic templates. Paid social targeted by role, industry, seniority, and intent so your budget reaches the right decision-makers.' },
          { title: 'Content Marketing & Inbound', description: 'Long-form content, thought leadership articles, case studies, and resource assets that attract the right audience and convert them over time. Gated content, email nurture sequences, and lead scoring built around your sales process. Content is written and optimised for both search engines and human readers.' },
          ...
          { title: 'B2B Digital Marketing', description: 'Messaging architecture, value proposition development, and channel sequencing built for complex B2B sales cycles. LinkedIn outreach, account-based marketing (ABM), and sales enablement content aligned to your funnel. Particularly effective for technology, professional services, and industrial businesses selling to enterprises in the Gulf.' },
          ...
          { title: 'Digital Strategy & Competitive Audit', description: 'Before recommending a channel mix, we audit your existing digital presence — SEO health, analytics accuracy, ad account structure, content library, and how your competitors are performing in search results. Strategy comes before execution. You will know exactly where you stand before any budget is committed.' },
        ],
      },
      {
        eyebrow: 'HOW WE WORK',
        ...
        items: [
          { title: 'Digital Audit & Baseline', description: 'We start by auditing your existing digital presence — SEO health, analytics accuracy, ad account structure, content library, and competitive positioning in search. The audit surfaces quick wins and long-term priorities before a single campaign launches.' },
          ...
          { title: 'Quarterly Strategy Review', description: 'Every quarter we revisit the strategy— competitive landscape, channel performance, and the roadmap for the next 90 days. Programmes that compound require a steady pace of small improvements over time.' },
        ],
      },
    ],
    whyUs: {
      eyebrow: 'WHY COMPASS ITS',
      heading: 'Why Businesses Choose Us for Digital Marketing',
      intro: 'We know the local market and how to reach decision-makers here. We report what moved the number — not what was busy.',
      points: [
        'Based in Doha— we know local search behaviour and what audiences here expect',
        ...
        'Bilingual capability — English and Arabic campaigns for businesses targeting both audiences',
        'B2B and B2C experience across professional services, technology, retail, and industrial sectors',
      ...
      credentials: [
        ...
        { title: 'Meta Advertising', description: 'Experienced in Meta Ads Manager for Facebook and Instagram campaigns — including audience building, creative testing, retargeting, and conversion optimisation.' },
        ...
        { title: 'LinkedIn Campaign Manager', description: 'LinkedIn advertising for B2B businesses — targeting by job title, seniority, company size, and industry. Particularly effective for professional services and technology companies reaching decision-makers.' },
      ],
    },
    faq: [
      { question: 'What digital marketing services do you offer?', answer: 'We provide SEO, Google Ads (SEM), social media marketing on LinkedIn and Instagram, content marketing, email automation, B2B communication strategy, and analytics and attribution — all managed under one integrated strategy.' },
      { question: 'How long does SEO take to show results?', answer: 'SEO typically shows meaningful movement in 3–6 months depending on competition, current site health, and keyword targets. We establish a baseline audit in month one, begin technical and content work in month two, and report on ranking progress weekly.' },
      { question: 'Do you run Google Ads campaigns?', answer: 'Yes. We manage Google Ads and Bing Ads campaigns. We handle keyword research, ad copy, bid strategy, landing page alignment, and monthly optimisation — reporting on what actually moved the number.' },
      { question: 'How much does digital marketing cost in Qatar?', answer: 'Costs vary by channel mix, competition level, and scope. We offer project-based and retained engagement models. We recommend starting with a defined audit and 90-day programme before committing to a longer retainer — so you can see results before scaling the budget.' },
      { question: 'Can you run campaigns in both Arabic and English?', answer: 'Yes. We deliver campaigns in both English and Arabic, covering bilingual SEO, Arabic ad copy, and localised content. That matters for businesses targeting both expatriate and Qatari audiences.' },
      { question: 'Do you work with B2B businesses?', answer: 'Yes. We have experience with B2B digital marketing across professional services, technology, and industrial sectors. LinkedIn campaigns, account-based marketing, and sales enablement content are all in scope.' },
    ],
  },
  ar: {
    hero: {
